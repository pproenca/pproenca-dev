...
Claude was making progress. Tests were green, things were compiling. But we were building on sand. The tests were passing because they tested _my implementation_, not the _correct behaviour_. There's a difference, and it's the difference between feeling productive and actually being productive.
